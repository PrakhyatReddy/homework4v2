...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newDailyReminderModal">
...
<!-- Modal -->
<div class="modal fade" id="newDailyReminderModal" tabindex="-1" aria-labelledby="newDailyReminderModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="newDailyReminderModalLabel">New Daily Reminder</h1>
